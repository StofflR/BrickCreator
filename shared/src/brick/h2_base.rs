...
use crate::types;
const TYPE: crate::types::BrickType = types::BrickType::H2Base;

// constants
const WIDTH: f32 = 348.181;
const HEIGHT: f32 = 94.748;
pub const DEFAULT_Y_OFFSET: f32 = 0.09;

#[derive(Clone, PartialEq)]
pub struct BrickH2Base {
    pub base: BaseBrick,
}

impl std::ops::Deref for BrickH2Base {
...
impl std::ops::DerefMut for BrickH2Base {
    fn deref_mut(&mut self) -> &mut BaseBrick {
        &mut self.base
    }
}

impl Default for BrickH2Base {
    fn default() -> Self {
        Self {
            base: BaseBrick {
