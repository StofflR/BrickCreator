...
const HEIGHT: f32 = 72.95;
pub const DEFAULT_Y_OFFSET: f32 = 0.22;
const TYPE: crate::types::BrickType = types::BrickType::H1Control;

#[derive(Clone, PartialEq)]
pub struct BrickH1Control {
    pub base: BaseBrick,
}

impl std::ops::Deref for BrickH1Control {
...
impl std::ops::DerefMut for BrickH1Control {
    fn deref_mut(&mut self) -> &mut BaseBrick {
        &mut self.base
    }
}

impl Default for BrickH1Control {
    fn default() -> Self {
        Self {
            base: BaseBrick {
