...
pub const DEFAULT_Y_OFFSET: f32 = 0.13;
const TYPE: crate::types::BrickType = types::BrickType::H1Base;

#[derive(Clone, PartialEq)]
pub struct BrickH1Base {
    pub base: BaseBrick,
}

impl std::ops::Deref for BrickH1Base {
...
impl std::ops::DerefMut for BrickH1Base {
    fn deref_mut(&mut self) -> &mut BaseBrick {
        &mut self.base
    }
}

impl Default for BrickH1Base {
    fn default() -> Self {
        Self {
            base: BaseBrick {
